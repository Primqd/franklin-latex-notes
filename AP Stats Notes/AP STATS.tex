...
Similarly to finite distributions, distributions will have shapes, often with skews and peaks. The mean of a density curve... exists (fix) and the median of the density curve splits the curve into two equal-area halves.
While the mean-median location principles still apply, they aren't too useful as it's relatively hard to locate the mean of a curve by analyzing it.
