...
Societies tackle this problem in three primary ways: \textbf{command economies}, \textbf{capitalism}, or a mix of the two.
...
\begin{definition}[Allocative Efficency]
...
\begin{figure}[h] % h = where it appears in text
    \centering
